...
-- ── Analytics: Pre-computed Daily Rollups ───────────────────────────────
...
CREATE INDEX IF NOT EXISTS idx_ds_day
  ON daily_stats(day);
...
CREATE INDEX IF NOT EXISTS idx_des_day
...
--     idx_pv_created         — page_views(created_at)
--     idx_ae_created         — analytics_events(created_at)
