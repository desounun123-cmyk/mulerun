...
router.post('/avatar', requireAuth, (req, res) => {
  upload.single('avatar')(req, res, async (err) => {
    ...
    try {
      ...
      // Run full-size and thumbnail pipelines in parallel (both use .clone()
      // so they decode the source buffer independently in sharp's thread pool)
      await Promise.all([
...
router.post('/push/subscribe', requireAuth, pushSubscribeLimit, (req, res) => {
  try {
