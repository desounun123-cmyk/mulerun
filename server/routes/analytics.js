...
// ── Auth middleware ──────────────────────────────────────────────
// Centralized admin gate for JSON API endpoints in this router.
// Mirrors the requireAdmin pattern used in index.js and the
// requireAuth pattern in other route modules, returning JSON
// errors (not HTML) since these are API consumers.
