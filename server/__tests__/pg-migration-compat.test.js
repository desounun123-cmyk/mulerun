...
function resolveServerFile(relativePath) {
  const candidates = [
    ...
    path.join(__dirname, '..', 'db', relativePath),  // from server/__tests__ → server/db/
    path.join(__dirname, '..', 'utils', relativePath),  // from server/__tests__ → server/utils/
...
const pgSchemaPath = (() => {
  const candidates = [
    path.join(__dirname, '..', 'db', 'pg-schema.sql'),
    path.join(__dirname, '..', 'mulerun', 'server', 'db', 'pg-schema.sql'),
    path.join(__dirname, '..', 'server', 'db', 'pg-schema.sql'),
